  ...
  <div className="overflow-y-auto h-[90vh] p-6">
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <div className="mt-3">
          {formData.thumbnail ? (
            <img src={formData.thumbnail} alt="" className="w-40 h-40 rounded-md object-cover" />
          ) : (
            <img src={currentProduct.thumbnail} alt="" className="w-40 h-40 rounded-md object-cover" />
          )}
        </div>
        <button
          type="button"
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2 mt-3">
          {(formData.images || currentProduct.images).map((image, index) => (
            <img
              key={index}
              src={image}
              alt={`Uploaded ${index}`}
      ...
      <div>
        ...
        <div className="text-sm text-gray-600 mb-2">Old category: {oldCategory}</div>
        <div className="flex flex-wrap gap-3">
          {categories.map((category) => (
            <div key={category._id} className="border p-2 rounded-md shadow-sm">
              <div
              ...
              {whichCategory === category._id && childCategories.length > 0 && (
                <div className="mt-2">
